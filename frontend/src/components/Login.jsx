        ...
        <div className="min-h-screen pt-32 pb-20 flex justify-center items-center bg-gym-gray px-4">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Enter your details to train</p>
                </div>
                ...
                <div className="mt-8 text-center text-sm font-bold text-gray-400 uppercase tracking-tight">
                    Don't have an account? <Link to="/register" className="text-electric-blue hover:underline ml-1">Join the tribe</Link>
                </div>
            </motion.div>
        </div>
    );
